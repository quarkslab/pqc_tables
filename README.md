...
| Rainbow             | V-Standard, V-CZ, V-compressed | Finalist             | Compliant       [[6](#6)] |
...
| Rainbow            | I, III, V          [[6](#6)] | V-Standard                            | Multivariate         | Finalist             | Compliant               | 2,451,096 [[19](#19)] / 2,451,128 [[20](#20)] | 2,869,440 [[6](#6),[[12](#12)] / 3,087,600 [[20](#20)] |               264 [[20](#20)] |
| Rainbow            | I, III, V          [[6](#6)] | V-CZ                                  | Multivariate         | Finalist             | Compliant               | 2,451,096 [[19](#19)] / 2,451,128 [[20](#20)] |                                    655,944 [[20](#20)] |               264 [[20](#20)] |
| Rainbow            | I, III, V          [[6](#6)] | V-Compressed                          | Multivariate         | Finalist             | Compliant               |                                64             |                                    655,944 [[20](#20)] |               264 [[20](#20)] |
...
<a name="19">[19]</a> By assuming that `o1 = 36`, `o2 = 64` and `v1 = 148` which is coherent with the parameters in [[6](#6)]:
  * the formula in page 17 of the documentation gives the equation  `o1 * o2 + v1 * (o1 + o2) + o1 * o2 + o1 * (v1 * (v1 + 1) / 2 + v1 * o1) + o2 * ((v1 + o1) * (v1 + o1 + 1) / 2 + (v1 + o1) * o2)`
